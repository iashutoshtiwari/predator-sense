...
def main():
    ...
    required = [
        ...
        repo_root / "src" / "predator_sense" / "assets" / "fonts" / "Orbitron-Regular.ttf",
        repo_root / "src" / "predator_sense" / "assets" / "fonts" / "Orbitron-Bold.ttf",
        repo_root / "src" / "predator_sense" / "assets" / "fonts" / "JetBrainsMono-Regular.ttf",
        repo_root / "src" / "predator_sense" / "assets" / "fonts" / "JetBrainsMono-Bold.ttf",
